...
A Subject represents a subject (whether a volunteer, patient, a phantom, or an artificial data set). Every Subject in a Project must have a unique **subject_id**, which is a 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjExODQ2NDY3XX0=
-->